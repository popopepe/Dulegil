...
import floatingactionbutton.FloatingScrollView.OnScrollChangedListener;
...
public class FloatingActionButton extends ImageButton {
	...
	public void show(boolean animate, int i) {
		toggle(true, animate, false, i);
	}

	public void hide(boolean animate,int i) {
		toggle(false, animate, false, i);
	}

	private void toggle(final boolean visible, final boolean animate, boolean force ,  int i) {
